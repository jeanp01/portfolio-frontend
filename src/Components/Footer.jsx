...
const Footer = () => {
  return (
    <footer id="Ftext" className=" bg-light3 text-contact dark:bg-darkbg  ">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="dark custom"
      ...
      <div className=" dark:text-light2 text-contact mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <ul className=" mt-20 mb-20   flex flex-wrap justify-center gap-6 md:gap-8 md:gap-22">
          <li className="md:px-18">
            <a
              className="dark:text-light2 text-contact   hover:text-gray-700/75 dark:hover:text-gray-700/75  "
              href="#Home"
            >
              Home
            </a>
