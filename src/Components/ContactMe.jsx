...
const ContactmMe = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_hjy7xtr', 'template_qbecks5', form.current, 'wdYtI2BJ4GJK2OsZA')
      .then((result) => {
...
<section id='ContactMe' className="relative bg-white dark:bg-darkbg dark:text-light1 ">
  <div className="lg:grid md:h-screen  lg:grid-cols-12">
    ...
    >
      ...
      <div className="hidden lg:relative lg:block lg:p-12">
        ...
        If you want to make your projects and ideas a reality, do not hesitate to contact me to start taking the first step together.  </p>
      </div>
    </section>
    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        <div className=" py-16 relative -mt-16 block lg:hidden">
          ...
          <h1
            className="pt-8 font-bold text-5xl md:text-6xl font-arvo text-left  pb-6 md:pb-10"
          >
            Contact Me
          </h1>

          <p className=" md:mt-4 md:block font-rokkitt text-left text-xl  md:text-2xl">
          If you want to make your projects and ideas a reality, do not hesitate to contact me to start taking the first step together.
          </p>
        </div>

        <form ref={form} onSubmit={sendEmail} action="#" className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6">
            <label htmlFor="Email" className="block  text-xl font-dosis font-bold text-gray-700">
              Email
            </label>
          ...
          <div className="col-span-6">
            <label htmlFor="OrderNotes" className="sr-only">Order Notes</label>
              <div className="overflow-hidden">
                <textarea name='message' className=" outline-none resize-none font-dosis font-bold border-b border-gray-300  border-none shadow-md rounded-lg p-1 mt-2 w-full border-gray-200  focus:border-blue-500 focus:ring focus:ring-blue-200" id="OrderNotes" cols="30" rows="4"  placeholder="Message...">
                </textarea>
            </div>
          </div>
